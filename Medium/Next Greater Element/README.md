<h2><a href="https://www.geeksforgeeks.org/problems/next-larger-element-1587115620/1?page=1&category=Data%20Structures,Arrays,Mathematical,Strings,Sorting,Hash,Linked%20List,Stack,Searching,Recursion,Binary%20Search,Prime%20Number,prefix-sum,factorial,doubly-linked-list,Merge%20Sort,Data%20Type,Pointers&difficulty=Medium&sortBy=submissions">Next Greater Element</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array <strong>arr[ ]</strong> of size <strong>N</strong> having&nbsp;elements, the&nbsp;task is to find the next greater element for each element of the array in order of their appearance in the array.<br>
